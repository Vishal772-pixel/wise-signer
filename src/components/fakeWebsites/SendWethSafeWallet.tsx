...
export default function SafeWallet({
  ...
  useEffect(() => {
    if (localQuestionId) {
      ...
      setFormattedAmount(
        parseFloat(questions[localQuestionId].otherData![0].amount).toString(),
      );
      setChainPrefix(questions[localQuestionId - 1].otherData![0].chainPrefix);
      setRecipientAddress(
        questions[localQuestionId - 1].otherData![0].chainPrefix +
          ":" +
          questions[localQuestionId - 1].otherData![0].recipient,
      );
      setZeroAddress(
        questions[localQuestionId - 1].otherData![0].chainPrefix +
      ...
      setTargetContract(
        questions[localQuestionId - 1].otherData![0].targetContract,
      );
      setTargetFunction(
        questions[localQuestionId - 1].otherData![0].targetFunction,
      );
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mb-6">
                ...
                <div className="mt-8">
                  <button
                    onClick={handleNext}
                    className="cursor-pointer px-8 py-3 bg-green-500 text-black rounded-lg hover:bg-green-600"
                  >
                    Next
                  </button>
                </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-base">
                            ...
                            <span className="px-1 text-purple-400 font-medium">
                              WETH
                            </span>
                          </span>
                          <button
