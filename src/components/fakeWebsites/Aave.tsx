...
import { FaEthereum, FaInfo, FaGasPump, FaTimes, FaExclamationTriangle } from "react-icons/fa";
                ...
                <div className="mb-6">
                    ...
                    <div className="bg-[#252A3F] rounded-lg p-3">
                        ...
                        <div className="flex justify-between items-center mt-2">
                            ...
                            <div className="flex items-center">
                                <span className="text-gray-400 text-sm mr-2">Wallet balance {WALLET_BALANCE}</span>
                ...
                {transactionCancelled && (
                    <div className="mt-4 bg-[#422230] text-[#EA4A5A] p-4 rounded-lg flex items-center">
                        ...
                        <div className="flex-1">
                            ...
                            <a href="#" className="underline ml-1">copy the error</a>
                        </div>
                    </div>
                )}
