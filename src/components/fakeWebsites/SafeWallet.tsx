...
import {
  FRIEND_WALLET,
  ZKSYNC_AAVE_WRAPPED_TOKEN_GATEWAY_V3,
  YOUR_WALLET,
  ARBITRUM_WETH,
  MULTI_SIGNATURE_SIGNER_WALLET,
  MULTI_SIGNATURE_WALLET,
  questions,
  SAFE_WALLET_QUESTION_START,
} from "@/data/questions";
...
export default function SafeWallet({
  ...
  useEffect(() => {
    if (questionId) {
      ...
      setFormattedAmount(
        parseFloat(
          questions[questionId - 1].otherData![otherDataNumber].amount,
        ).toString(),
      );
      setChainPrefix(
        questions[questionId - 1].otherData![otherDataNumber].chainPrefix,
      );
      setRecipientAddress(
        questions[questionId - 1].otherData![otherDataNumber].chainPrefix +
          ":" +
          questions[questionId - 1].otherData![0].recipient,
      );
      setZeroAddress(
        questions[questionId - 1].otherData![otherDataNumber].chainPrefix +
      ...
      setRawDataSize(
        questions[questionId - 1].otherData![otherDataNumber].rawDataSize,
      );
      setWadValue(
        questions[questionId - 1].otherData![otherDataNumber].wadValue,
      );
      ...
      setTargetContract(
        questions[questionId - 1].otherData![otherDataNumber].targetContract,
      );
      setTargetFunction(
        questions[questionId - 1].otherData![otherDataNumber].targetFunction,
      );
      setRawData(questions[questionId - 1].otherData![otherDataNumber].rawData);
      setDomainHash(
        questions[questionId - 1].otherData![otherDataNumber].domainHash,
      );
      setMessageHash(
        questions[questionId - 1].otherData![otherDataNumber].messageHash,
      );
      setEip712Hash(
        questions[questionId - 1].otherData![otherDataNumber].eip712Hash,
      );
        ...
        <div className="w-64 bg-[#121212] border-r border-gray-800 p-4">
          ...
          <div className="mb-6">
            <div className="mb-4 bg-purple-100 bg-opacity-20 p-2 rounded-md">
              <span className="text-purple-300 text-sm">{chainPrefix}</span>
            </div>
              ...
              <div>
                ...
                {otherDataNumber === 1 ? (
                  <div>
                    <span>
                      {chainPrefix}:
                      {truncateAddress(MULTI_SIGNATURE_SIGNER_WALLET)}
                    </span>
                    <button
                      className="ml-1 text-gray-400 hover:text-gray-300 cursor-pointer"
                      onClick={() =>
                        copyToClipboard(
                          `${chainPrefix}:${MULTI_SIGNATURE_SIGNER_WALLET}`,
                        )
                      }
                    >
                      <FaCopy size={10} />
                  ...
                  <div>
                    <span>
                      {chainPrefix}:{truncateAddress(MULTI_SIGNATURE_WALLET)}
                    </span>
                    <button
                      className="ml-1 text-gray-400 hover:text-gray-300 cursor-pointer"
                      onClick={() =>
                        copyToClipboard(
                          `${chainPrefix}:${MULTI_SIGNATURE_WALLET}`,
                        )
                      }
                    >
                      <FaCopy size={10} />
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-6">
              ...
              <div className="mb-6">
                ...
                <span className="font-mono bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-blue-600 dark:text-blue-400 text-sm">
                  {targetFunction}
                </span>
                <span className="text-gray-500 dark:text-gray-400 mx-1">
                  on
                </span>
                <span className="font-mono bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-purple-600 dark:text-purple-400 text-sm">
                  {targetContract}
                </span>
                <div className="flex flex-col space-y-4 py-1">
                  {/* TODO: This needs a refactor and should live in questions.ts */}
                  {(questionId === SAFE_WALLET_QUESTION_START ||
                    questionId === SAFE_WALLET_QUESTION_START + 2) && (
                    <div className="space-y-2">
                      <div className="flex items-center">
                        <span className="text-gray-400 w-16 text-base">
                          Value:
                        </span>
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="px-16 flex items-center px-6">
                            ...
                            <span className="text-base">
                              <span className="ml-1 text-white">
                                {
                                  questions[questionId - 1].otherData![
                                    otherDataNumber
                                  ].eip712Hash!
                                }
                              </span>
              ...
              <div className="border border-gray-700 rounded-lg overflow-hidden mb-6">
                ...
                {showTransactionDetails && (
                  <div className="p-4 bg-[#111]">
                    ...
                    <div className="text-white-400 font-bold mb-1">
                      Transaction Hashes
                    </div>
                    <div className="flex justify-between items-center mb-2">
