...
export default function SendEth({
  ...
  const transactionOrSignatureData = (
    questions[questionId - 1] as SignOrRejectQuestionData
  ).transactionOrSignatureData;
  const amount = (transactionOrSignatureData as TransactionDetails).amount!;
  const amountWei = (parseFloat(amount) * 10 ** 18).toLocaleString("fullwide", {
    useGrouping: false,
  });
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="mt-8">
            <button
              ...
              className={`w-full px-6 py-4 rounded-lg flex items-center justify-center cursor-pointer ${
                buttonDisabled
