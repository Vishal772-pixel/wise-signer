    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-950 to-black text-white">
            ...
            <main className="container mx-auto px-4 pt-8 pb-16">
                <h1 className="text-4xl font-bold text-center mb-12">Protocol Upgrade Proposals</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gray-900 rounded-xl p-6">
                        ...
                        <div className="space-y-6">
                            <div className="flex flex-col">
                                ...
                                <span className="font-mono break-all">0x3774f8d203c4b4a7cf46c7867b c726a1350d77345c4fd8d2f92f64 c53b4765b8</span>
                            </div>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <a href="#" className="text-blue-400 flex items-center">
                                    ...
                                    <svg className="ml-1" width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10 5H5V19H19V14M14 5H19V10M19 5L9 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </a>
                            </div>
                    ...
                    <div className="bg-gray-900 rounded-xl p-6">
                        <h2 className="text-2xl font-bold mb-6">Security Council Actions</h2>
                        <ChainButton
