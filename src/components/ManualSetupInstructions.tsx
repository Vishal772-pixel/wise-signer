  ...
  return (
    <div className="bg-zinc-800 p-6 rounded-lg max-w-3xl">
      ...
      <h2 className="text-2xl font-semibold mb-4">
        Manual Virtual Network Setup
      </h2>
      <p className="mb-6">
        Follow these instructions to manually create a Tenderly Virtual Network
        with the correct settings for this application. After setup, you'll just
        need to provide the RPC URL.
      </p>
      ...
      <div className="mb-8 p-4 bg-zinc-700 rounded-lg">
        ...
        <p className="mb-4">
          If you don't already have a Tenderly account, you'll need to create
          one.
        </p>
        <a
      ...
      <div className="mb-8 p-4 bg-zinc-700 rounded-lg">
        ...
        <p className="mb-4">
          If you don't already have a project, create a new one from your
          Tenderly dashboard.
        </p>
        <a
      ...
      <div className="mb-8 p-4 bg-zinc-700 rounded-lg">
        ...
        <p className="mb-4">
          From your project dashboard, go to the "Networks" section and click
          "Create Virtual Network". Use the following settings:
        </p>
      ...
      <div className="mb-8 p-4 bg-zinc-700 rounded-lg">
        ...
        <p className="mb-4">
          After creating the Virtual Network, you'll need to copy the Public RPC
          URL to use with this application.
        </p>
        <ol className="list-decimal ml-5 space-y-2">
          <li>Go to your newly created Virtual Network</li>
          <li>Find the "RPC Endpoints" section</li>
          <li>
            Copy the "Public RPC" URL (it should look like
            https://virtual.sepolia.rpc.tenderly.co/...)
          </li>
          <li>
            Paste this URL into the "RPC Endpoint URL" field in this application
          </li>
        </ol>
      </div>
